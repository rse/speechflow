...
- **Audio-to-Audio (a2a)**: ffmpeg, wav, mute, meter, vad, gender, gain, filler, compressor, expander, rnnoise, gtcrn, speex, pitch
...
- **Text-to-Audio (t2a)**: elevenlabs, kokoro, kitten, amazon, supertonic, openai, google
